...
import {activeKey, collapsed, renderGroup, toggleCollapsed, model} from "@/pages/chat/model";
import HomeGroupContent from "@/pages/chat/pages/group/HomeGroupContent.vue";
